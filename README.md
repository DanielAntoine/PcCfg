...
```powershell
pyinstaller --noconfirm --onefile --windowed --name PcCfg-v0.1.1ForTestOnly --icon Icon/PCSetup.ico --add-data "style;style" --add-data "profiles;profiles" dxm_pc_setup_gui.py
```
